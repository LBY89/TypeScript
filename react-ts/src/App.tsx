...
interface CourseNormalPart extends CoursePartBaseWithDes {
  type: "normal";
...
interface CourseSubmissionPart extends CoursePartBaseWithDes {
  type: "submission";
  exerciseSubmissionLink: string;
}

interface CourseRequirementPart extends CoursePartBaseWithDes {
  type: "special";
